...
public class AttrAttrgroupRelationController {
    ...
    public Resp<Object> deleteRelation(@RequestBody List<AttrAttrgroupRelationEntity> relationEntities){
        attrAttrgroupRelationService.deleteRelation(relationEntities);
        return Resp.ok(null);
    }
