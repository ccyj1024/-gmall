...
public class SpuInfoController {
    ...
    @GetMapping
    public Resp<PageVo> querySpuByKeyPage(QueryCondition queryCondition,
                                          @RequestParam(value = "catId",defaultValue = "0")Long catId){
        PageVo pageVo=spuInfoService.querySpuByKeyPage(queryCondition,catId);
    ...
    public Resp<Object> save(@RequestBody SpuInfoVO spuInfoVO){
		spuInfoService.saveSpuWithSku(spuInfoVO);
